...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.3.0/css/all.min.css')}}">
</head>
<body>
    <header>
                    ...
                    <div class="col-lg-6 col-md-5">
                        <div class="header__top__right">
                            <div class="header_top_link">
                                <a href="{{URL::to('/register')}}" class="head-link">Sign up</a>
                ...
                <div class="col-12 px-0">
                    <nav class="header__menu">
                        <ul class="mb-0 activeControl">
                            <li class="control"><a href="{{URL::to('/')}}">Home</a></li>
                            <li class="control"><a href="{{URL::to('/shop')}}">Shop</a></li>
                            <li class="control"><a href="{{URL::to('/addToCart')}}">Shopping details</a>
                            </li>
                            <li class="control"><a href="{{URL::to('/shoppingCart')}}">Shopping Cart</a></li>
                             @if(session()->has('id'))
                               <li class="control"><a href="{{URL::to('/logout')}}">Logout</a></li>
                            @else
                            <li class="control"><a href="{{URL::to('/login')}}">Login</a></li>
                            @endif
                        </ul>
                    </nav>
                </div>
